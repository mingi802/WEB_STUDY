...
<body>
		<form name="loginform" action="./login_ok.jsp" method="GET" accept-charset="UTF-8">
		...
		<br/>
		<form id="show-users-form" name="show-users-form" action="./show_users.jsp" method="GET" accept-charset="UTF-8">
			<table>
			<tr>
