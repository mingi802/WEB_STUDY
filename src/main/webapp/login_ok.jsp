		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="before-id" id="before-id" value="<%=MEMBER_ID%>">
				</td>
			</tr>
			<tr>
			...
			<tr align="right">
				<td class="title" colspan="2"><input type="submit" value="수정">&nbsp;<input type="submit" value="회원 탈퇴" formaction="./DeleteUser.jsp">
			</tr>
		</table>
	</form>
</body>
